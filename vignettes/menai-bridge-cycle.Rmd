...
```{r, echo=FALSE, fig.cap="Desire lines crossing the Menai Straight frequented by 5 or more cyclists in the 2011 census (blue) and all desire lines crossing the straight (green). Widths in both cases are proportional to the number of commutes by all modes."}
...
Of the `r sum(l[[3]])` commuters whose desire line crosses the Menai Straight, barely 1% of cycled. Is this simply due to the high average distance and hillines in the region? The graph below shows the trip distance-frequency distribution of the selected flows.
