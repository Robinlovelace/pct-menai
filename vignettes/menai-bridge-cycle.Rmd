...
Of the `r sum(l[[3]])` commuters whose desire line crosses the Menai Strait, barely 1% of cycled. Is this due to the distance and hillines in the region? The graph below shows the trip distance-frequency distribution of the selected flows.
...
```{r cycling-potential, echo=FALSE, fig.cap="Level of commuter cycling in the 2011 census (black) and under Government Target (blue) and Go Dutch (red) scenarios, without including the impact of route gradient. Each point represents a desire line. The diameter of the points is proportional to the number of commuters by all modes for each desire line."}
# ??logit
